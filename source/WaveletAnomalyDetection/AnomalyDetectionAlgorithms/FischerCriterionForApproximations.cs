...
{
    /// <summary>
    /// Статистический алгоритм обнаружения аномалий на основе критерия Фишера для средних значений.
    /// </summary>
    public class FischerCriterionForApproximations : IAnomalyDetectionAlgorithm
    {
        public string Name => "Критерий Фишера (средние значения)";
